...
#define N 50
#define ARQUIVO "C:\\Users\\RONALDO\\Documents\\VSCODE\\C\\ED\\Agenda de contatos\\Agenda_contato.csv" 
...
void imprimircontatos(contato agenda[], int contador) {
        ...
        do {
            ...
            switch (p) {
                case 1:
                    ...
                    break;
                case 2:
                    imprimircontatos(agenda, contador);
                    break;
                case 3:
